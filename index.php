	...
	<div class="container">
		...
		<section class="main">
			<div class="get-started">
                <h1>I'm Atoyegbe Adeyemi <span class="for">and I am a </span> Favcoder(Ai-student)</h1>
				<p>My mission for Favcode is to: To contribute to  Developing and deploying enterprise software products.</p>
                
                <h2>This is why you should choose me</h2>
                <p> 
	          I have a very good understanding of HTML and CSS... I am also good using  javascript(intermidate) to manipulate the DOM,
		   ...
		   i love learning new things and i am also willing to learn and contribute in a positive way to your company.. 
		    i will be very much happy if you consider me not for  being the best but me wanting to be the best with your company.. i do not just work hard but i also work smart.
			  ...
			  Thank you for giving me this opportunity to express myself.. 
				...
				<p class="meta">Here is my <a href="https://www.linkedin.com/in/atoyegbe-adeyemi-9bb375148" target="_blank" target="_blank">LinkedIn Page</a>.</p>
			</div>

			<div class="artwork">
				<img src=""https://scontent-bru2-1.xx.fbcdn.net/v/t1.0-9/22046843_886160541533170_5779732796252439406_n.jpg?_nc_cat=0&oh=dba845ae26b3640b1b6818560c09a98c&oe=5B6B560F" alt="Adeyemi">
			</div>
		</section>
		<footer>
